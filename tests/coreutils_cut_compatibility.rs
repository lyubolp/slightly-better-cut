...
fn test_06_1_output_delimiter_single_range() {
    // Arrange
    let cut_arguments = vec!["-d", ",", "-f", SINGLE_RANGE_CUT, SAMPLE_FILE, "--output-delimiter", "-"];
    let sbcut_arguments = vec!["-d", ",","-f", SINGLE_RANGE_SBCUT, SAMPLE_FILE, "--output_delimiter", "-"];
...
fn test_06_2_output_delimiter_two_single_ranges() {
    // Arrange
    let cut_arguments = vec!["-d", ",", "-f", SINGLE_RANGE_CUT, ",", SINGLE_RANGE_CUT_2, SAMPLE_FILE, "--output-delimiter", "-"];
    let sbcut_arguments = vec!["-d", ",","-f", SINGLE_RANGE_SBCUT, ",", SINGLE_RANGE_SBCUT_2, SAMPLE_FILE, "--output_delimiter", "-"];
...
fn test_06_3_output_delimiter_one_range() {
    // Arrange
    let cut_arguments = vec!["-d", ",", "-f", START_END_RANGE_CUT, SAMPLE_FILE, "--output-delimiter", "-"];
    let sbcut_arguments = vec!["-d", ",","-f", START_END_RANGE_SBCUT, SAMPLE_FILE, "--output_delimiter", "-"];
...
fn test_07_3_nul_terminated_start_end_range(){
    ...
    let sbcut_arguments = vec!["-c", START_END_RANGE_SBCUT, SAMPLE_FILE_NUL_TERMINATED, "-z"];
...
fn test_07_5_nul_terminated_single_start_range(){
    // Arrange
    let cut_arguments = vec!["-c", SINGLE_START_RANGE_CUT, SAMPLE_FILE_NUL_TERMINATED, "-z"];
    let sbcut_arguments = vec!["-c", SINGLE_START_RANGE_SBCUT, SAMPLE_FILE_NUL_TERMINATED, "-z"];
...
fn test_07_6_nul_terminated_single_single_start_range(){
    // Arrange
    let cut_arguments = vec!["-c", SINGLE_SINGLE_START_RANGE_CUT, SAMPLE_FILE_NUL_TERMINATED, "-z"];
    let sbcut_arguments = vec!["-c", SINGLE_SINGLE_START_RANGE_SBCUT, SAMPLE_FILE_NUL_TERMINATED, "-z"];
